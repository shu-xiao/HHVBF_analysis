...
void anaCode() {
    ...
    auto bbb = bb.Define("vbfjList"     ,"vbfBasis(t1.nJet,t1.Jet_pt,t1.Jet_eta,t1.Jet_phi,t1.Jet_mass,lead_fatjet,sublead_fatjet)").Filter("vbfjList[0]>=0","AK4 jet basic cuts");
    auto bbbb = bbb.Define("vbfjKinList","vbfCut(vbfjList, t1.Jet_eta)").Filter("vbfjKinList[0]>0","AK4 eta cuts");
    auto bbbbb = bbbb.Define("vbfjCom","vbfInv(vbfjKinList,t1.Jet_pt,t1.Jet_eta,t1.Jet_phi,t1.Jet_mass,300)")
        .Filter("vbfjCom>=0","vbf jet invariance mass cut").Define("ind1","vbfjCom/100").Define("ind2","vbfjCom%100");
    //auto bbbb = bbb.Filter("vbfjList[0]<0","AK4 cut");
    ...
    //auto finalNode = bbbbb.Filter("ind1>=0&&ind2>=0","vbf cut").Define("lead_fatjet_sdmass","FatJetInfo.Jet_massSoftDrop[0]").Define("sublead_fatjet_sdmass","FatJetInfo.Jet_massSoftDrop[1]");
    auto finalNode = bbbbb.Define("lead_fatjet_sdmass","FatJetInfo.Jet_massSoftDrop[0]").Define("sublead_fatjet_sdmass","FatJetInfo.Jet_massSoftDrop[1]");
